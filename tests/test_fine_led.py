...
def spy_assert_fine_led(mocker, pytenki_init, func_name, weather):
...
def test_operate_fine_led_to_on(mocker, pytenki_init, weather):
    spy_assert_fine_led(mocker, pytenki_init, 'on', weather)
...
def test_operate_fine_led_to_pulse(mocker, pytenki_init, weather):
    spy_assert_fine_led(mocker, pytenki_init, 'pulse', weather)
...
def test_operate_fine_led_to_blink(mocker, pytenki_init, weather):
    spy_assert_fine_led(mocker, pytenki_init, 'blink', weather)
...
def test_operate_fine_led_to_off(mocker, pytenki_init, weather):
    spy_assert_fine_led(mocker, pytenki_init, 'off', weather)
